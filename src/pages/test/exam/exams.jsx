            ...
            {filteredExams.map((exam) => (
              ...
              >
                ...
                <div className="mt-2 text-sm text-gray-600">
                  <p>Date: {formatDate(exam.exam_date)} • Duration: {exam.duration} minutes</p>
                  <p>Created: {formatDate(exam.created_at)} • Modified: {exam.modified_at ? formatDate(exam.modified_at) : "Never"}</p>
                  {exam.description && (
