  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <StatCard icon={FileText} label="Upcoming Exams" value="8" color="bg-purple-500" onClick={() => router.push("/admin/exams")} />
        <StatCard icon={Bell} label="Manage Notifications" value="23" color="bg-amber-500" onClick={() => router.push("/admin/manage-notifications")} />
        <StatCard icon={Plus} label="Create Exams" value="+" color="bg-red-500" onClick={() => router.push("/admin/create")} />
      </div>
    </div>
  );
};
